...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {88.05754176146692, 127.7815699658703};
	double hsvThresholdSaturation[] = {61.45683825016022, 255.0};
	double hsvThresholdValue[] = {33.93885154518292, 255.0};
